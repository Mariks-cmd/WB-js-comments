...
function displayComments(comments) {
    for (const [id, entry] of Object.entries(comments)) {
        ...
        comment.querySelector('.remove').setAttribute('href', 'https://comments-test.000webhostapp.com/app/api.php?action=remove&remove=' + entry.id);
        comment.querySelector('.update').setAttribute('href', 'https://comments-test.000webhostapp.com/app/api.php?action=update&id=' + entry.id);
...
load('https://comments-test.000webhostapp.com/app/api.php?action=get', displayComments);
